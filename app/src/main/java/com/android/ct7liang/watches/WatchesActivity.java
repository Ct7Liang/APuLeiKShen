package com.android.ct7liang.watches;
...
/**
 * 基于ConstraintLayout布局, 实现时钟动画
 */
public class WatchesActivity extends BaseActivity {

    private View second;
    private View minute;
    private View hour;
    private View second_end;
    private int lastMin;
    ...
    public int setLayout() {
        return R.layout.activity_watches;
    }
...
//        String[] split = {"23", "59", "55"};
    ...
    public void rotateAnimSecond(int s) {
        ...
        Animation anim1 = new RotateAnimation(s*6, s*6+360f, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0);
        anim1.setFillAfter(true); // 设置保持动画最后的状态
        anim1.setDuration(60000); // 设置动画时间
        anim1.setRepeatCount(-1);
        anim1.setInterpolator(new LinearInterpolator()); // 设置插入器

        second.startAnimation(anim);
        second_end.startAnimation(anim1);
    }
}