...
public class TextInsideCircleButtonActivity extends BaseActivity {

    @Override
    public int setLayout() {
        return R.layout.activity_inside_circle_button;
    }
    ...
    public void findView() {
        ...
        for (int i = 0; i < boomMenuButton.getPiecePlaceEnum().pieceNumber(); i++) {
            ...
            if (i==0){
                boomMenuButton.addBuilder(new TextInsideCircleButton.Builder().normalImageRes(R.mipmap.huaji).normalText("这是第"+i+"个").normalTextColor(Color.parseColor("#000000")));
            }else if (i==1){
                boomMenuButton.addBuilder(new TextInsideCircleButton.Builder().normalImageRes(R.mipmap.huaji).normalText("这是第"+i+"个"));
            }else{
