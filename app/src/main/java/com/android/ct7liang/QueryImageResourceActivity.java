...
public class QueryImageResourceActivity extends BaseActivity implements PhotoViewAttacher.OnPhotoTapListener {

    private ViewPagerFixed viewPager;
    private ArrayList<Integer> urls;
    private int position;

    public static void start(Context context, ArrayList<Integer> list, int position){
        Intent i = new Intent(context, QueryImageResourceActivity.class);
    ...
    public void initView() {
        viewPager.setAdapter(new PagerAdapter() {
            ...
            public Object instantiateItem(ViewGroup container, int position) {
                ...
                photoView.setOnPhotoTapListener(QueryImageResourceActivity.this);
